...
function plusReady(){
   ...
   console.dir("commonplusready")
    var _bridge2;
    if (plus.os.name == "Android") {
        _bridge2 = plus.android.importClass('tw.cactus.park.core.Bridge');
    } else if (plus.os.name == "iOS") {
        _bridge2 = plus.ios.importClass('CactusPark.WebUtil');
    }
    ...
    try {
        ...
        var ST = plus.storage.getItem("Server_Token");
        ...
        xhr.send(JSON.stringify({ id: ws.id }));
    } catch (e) {
...
//		 * @type number
//		 */
//        this.tapDelay = options.tapDelay || 200;//200;
...
//		 * @type number
//		 */
//        this.tapTimeout = options.tapTimeout || 400;//700;
